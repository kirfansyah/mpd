<div class="breadcrumbs" id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li>
			<a href="<?php echo site_url('absensi/'.$page_asal.'/set');?>">Daftar Ulang Anggota</a>
			<span class="divider">
				<i class="icon-angle-right"></i>
			</span>
		</li>
			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main no-padding">
						...
						<?php 
						echo form_open('daftar/sheller/search/'.$nourut.'/'.$tipe_submit.'/'.$idurut,array('id'=>'formCariTK' ,'class'=>'form-horizontal')); 
						echo form_fieldset();
						?>
						...
						<div id="hasilcari">
							<?php
							echo form_open('daftar/sheller/'.$tipe_submit.'/'.$nourut.'/'.$tipe_submit.'/'.$idurut,array('id'=>'formPilih' ,'class'=>'form-horizontal')); 
							echo form_fieldset();
							?>
								...
								<tbody>
									...
									?>										
										<tr>
											...
											<td class="center">
												<label>
													<input name="radioPilih" type="radio" value="<?php echo $row->FixNo.'#'.$row->IDSubPekerjaan;?>"/>
													<span class="lbl"></span>													
												</label>
											</td>
