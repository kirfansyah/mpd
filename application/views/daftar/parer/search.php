			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main no-padding">
						...
						<?php 
						echo form_open('daftar/parer/search/'.$nourut.'/'.$tipe_submit.'/'.$idurut,array('id'=>'formCariTK' ,'class'=>'form-horizontal')); 
						echo form_fieldset();
						?>
						...
						<div id="hasilcari">
							<?php
							echo form_open('daftar/parer/'.$tipe_submit.'/'.$nourut.'/'.$tipe_submit.'/'.$idurut,array('id'=>'formPilih' ,'class'=>'form-horizontal')); 
							echo form_fieldset();
							?>
