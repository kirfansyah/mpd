...
<div class="page-content">
	<div class="row-fluid">
		<div class="span12">
			<div class="judul">
				Hasil Timbang Air Kelapa
			</div>
			
			<div class="page-header">
				<?php echo form_open('transaksi/proses_timbangak',array('id'=>'formtimbangak' ,'class'=>'form-inline')); ?>
			...
			<table id="tabellistak" class="table table-hover table-bordered table-condensed">
				<thead>
					<tr>
					...
					<?php
						...
						foreach ($record as $r){
							...
							echo "<tr>
								...
								<td class='right'>".floatval($r->TotalAK)."</td>
								<td class='center'>
									<a href='edit/airkelapa/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-warning'><i class='icon-edit'></i> Edit</a>
									<a href='complete_trx/airkelapa/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-success'><i class='icon-check'></i> Complete</a>
								</tr>";
						}
					?>
				</tbody>
