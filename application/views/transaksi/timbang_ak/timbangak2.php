								...
								<table id="tabelMesin<?php echo $i;?>" class="table table-bordered table-condensed">
									...
									<tbody>
											...
											if ($detail_jumlah > 0) {
												foreach ($detail_mesin->result() as $dm) {
													...
													echo '<td class="center middle">
															...
															<a href="#" id="btnDelete" detailid="'.$dm->HasilTimbangAKID.'" nomormesin="'.$i.'" 
										...
										<tr class="bigger-120">
											...
											<td class="center middle">
												<input type="number" min="0" name="txtTimbang<?php echo $i;?>" placeholder='0' class="input input-small text-right numeric" /> 											
											</td>
									...
									<tfoot>
										<tr class="bigger-140 red">
											...
											<td class="center middle"><?php echo $totHasilAK;?></td>
											<td class="center middle">&nbsp;</td>
										</tr>
									</tfoot>
								</table>
