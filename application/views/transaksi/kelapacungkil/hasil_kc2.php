								...
								<table id="tabelMesin<?php echo $i;?>" class="table table-bordered table-condensed">
									...
									<tbody>
											...
											if ($detail_jumlah > 0) {
												foreach ($detail_mesin->result() as $dm) {
													...
													echo '<td class="center middle">
															...
															<a href="#" id="btnDelete" detailid="'.$dm->HasilKCID.'" nomormesin="'.$i.'" 
										...
										<tr class="bigger-120">
											...
											<td class="center middle">
												<input type="number" min="0" name="txtHasilKC<?php echo $i;?>" placeholder='0' class="input input-small text-right numeric" /> 
											</td>
											
											<td class="center middle">
												<button id="btnSimpan<?php echo $i;?>" name="SimpanMesin<?php echo $i;?>" class="btn btn-block btn-primary btn-medium btnSimpan" type="submit">
									...
									<tfoot>
										<tr class="bigger-140 red">
											<td class="center middle">#</td>
											<td class="center middle"><?php echo $totHasilKC;?></td>
											<td class="center middle">&nbsp;</td>
										</tr>
									</tfoot>
								</table>
