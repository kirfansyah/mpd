...
<div class="page-content">
	<div class="row-fluid">
		<div class="span12">
			<div class="judul">
				Hasil Timbang White Meat
			</div>
			
			<div class="page-header">
				<?php echo form_open('transaksi/proses_timbangwm',array('id'=>'formtimbangwm' ,'class'=>'form-inline')); ?>
				...
				<!--<select multiple="" class="chzn-select" name="txtLine" id="dropdownLine" data-placeholder="Pilih Line">-->
					<option value=""></option>
					<?php
			...
			<table id="tabellistwm" class="table table-hover table-bordered table-condensed">
				<thead>
					<tr>
						...
						<th class="right">Timbangan</th>
						<th class="right">Potongan Lain</th>
						<th class="right">Potongan Air</th>
					...
					<?php
						...
						foreach ($record as $r){
							...
							echo "<tr>
								...
								<td class='right'>".floatval($r->TotalTimbangan)."</td>
								<td class='right'>".floatval($r->TotalPotLain)."</td>
								<td class='right'>".floatval($r->TotalPotAir)."</td>
								<td class='center'>
									<a href='edit/whitemeat/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-warning'><i class='icon-edit'></i> Edit</a>
									<a href='complete_trx/whitemeat/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-success'><i class='icon-check'></i> Complete</a>
								</tr>";
						}
					?>
				</tbody>
