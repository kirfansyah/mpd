								...
								<table id="tabelMesin<?php echo $i;?>" class="table table-bordered table-condensed table-hover">
									...
									<tbody>
										...
										<tr class="bigger-120">
											...
											<td class="center middle">
												<input type="number" step="0.01" min="0" value="<?php echo set_value('txtTimbang'.$i);?>" name="txtTimbang<?php echo $i;?>" placeholder='0' class="input input-small text-right numeric" />
											</td>
											
											<td class="center middle">
												<input type="number" step="0.01" min="0" name="txtPotLain<?php echo $i;?>" placeholder='0' class="input input-mini text-right numeric" />
												
											</td>
											
											<td class="center middle">
												<input type="number" step="0.01" min="0" name="txtPotAir<?php echo $i;?>" placeholder='0' class="input input-mini text-right numeric" />
											</td>
