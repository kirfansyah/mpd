	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="txtIsi1" id="inputIsi" type="number" min="0" class="input text-right numeric"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="txtIsi2" id="inputIsi" type="number" min="0" class="input text-right numeric"
