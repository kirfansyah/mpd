	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="page-header">
				<?php echo form_open('transaksi/proses_isi_keranjang',array('id'=>'formIsiKeranjang' ,'class'=>'form-inline')); ?>
					...
					<?php
						...
						foreach ($record as $r){
							...
							echo "<tr>
								...
								<td class='right'>".number_format($r->Penambahan, 0, ',','.')."</td>
								<td class='right'>".number_format($r->Sisa, 0, ',','.')."</td>								
								<td class=''>
									<a href='edit/keranjang/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-warning'><i class='icon-edit'></i> Edit</a>
									<a href='complete_trx/keranjang/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-success'><i class='icon-check'></i> Complete</a>
								</tr>";
						}
					?>
				</tbody>
