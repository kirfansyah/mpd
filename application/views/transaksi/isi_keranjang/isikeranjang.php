...
//																			$idkrj1 = (!is_null($rt->IDKrjHistory)) ? $rt->IDKrjHistory: '';
																...
																if($Krj1 === '' && $Krj2 === ''){
																	echo '<td class="center middle">
																			<input name="txtTambahIsi1" id="inputTambahIsi1" type="number" min="0" class="input input-small text-right numeric" placeholder="0"/>
																		  </td>';
																	
																	echo '<td class="center middle">
																			<input name="txtTambahIsi2" id="inputTambahIsi2" type="number" min="0" class="input input-small text-right numeric" placeholder="0"/>
																		  </td>';
													...
													<table class="table table-striped table-condensed table-hover">
														...
														<tbody>
															...
															if ($sisa1 === 0 && $sisa2 === 0){
																$show_isilanjut = 0;
																echo '<td class="center middle">
																		<input type="number" min="0" name="txtSisa1" placeholder="0" class="input input-small text-right numeric" />
																	  </td>';
																echo '<td class="center middle"><input type="number" min="0" name="txtSisa2" placeholder="0" class="input input-small text-right numeric" /></td>';
																echo '<td class="center middle">
														...
														<tbody>
															...
															if ($isi1 === 0 && $isi2 === 0){
																if ($sisa1 > 0){
																	...
																	echo '<td class="center middle">
																			<input type="number" min="0" name="txtIsi1" placeholder="0" class="input input-small text-right numeric" />
																		  </td>';
																}
																...
																if ($sisa2 > 0){
																	...
																	echo '<td class="center middle">
																			<input type="number" min="0" name="txtIsi2" placeholder="0" class="input input-small text-right numeric" />
																		  </td>';
																}
