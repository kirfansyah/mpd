			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main no-padding">
						...
						<?php 
						echo form_open('absensi/sheller/search/'.$nomormesin,array('id'=>'formCariTK' ,'class'=>'form-horizontal')); 
						echo form_fieldset();
						?>
...
//								$option_pekerjaan[''] = '';
								...
								endforeach;
								foreach($cbosubpekerjaan as $r):
									$option_pekerjaan[$r->IDSubPekerjaan+500] = $r->SubPekerjaan;
								endforeach;
								$option_pekerjaan['1000'] = 'SEMUA';
						...
						<!-- <div class="control-group">
							<label class="control-label" for="dropdownPekerjaan">Sub Pekerjaan</label>
							<div class="controls">
							<?php
								//$extra_sub_pekerjaan = 'class="chzn-select" id="dropdownSubPekerjaan" data-placeholder="Pilih Sub Pekerjaan" ';
//								$option_pekerjaan[''] = '';
								//foreach($cbosubpekerjaan as $r):
								//	$option_sub_pekerjaan[$r->IDSubPekerjaan] = $r->SubPekerjaan;
								//endforeach;
								//echo form_dropdown('txtSubPekerjaan', $option_sub_pekerjaan, $selectsubpekerjaan, $extra_sub_pekerjaan);
							?>	
								<span class="help-inline red">Sub Pekerjaan Wajib Diisi!</span>
							</div>
						</div> -->
...
//								echo form_dropdown('txtPerusahaan', $option_perusahaan, $idperusahaan, $extra_perusahaan);
						...
						<div id="hasilcari">
							<?php
							echo form_open('absensi/sheller/simpanpilih/'.$nomormesin,array('id'=>'formPilih' ,'class'=>'form-horizontal')); 
							echo form_fieldset();
							?>
							...
							<table id="tabel_search_result" class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th class="center">Sub Pekerjaan</th>
