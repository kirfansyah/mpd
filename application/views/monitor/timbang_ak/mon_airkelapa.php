...
<div class="page-content">
	<h3 class="header smaller lighter blue">		
		<a href="<?php echo site_url('transaksi/timbang_airkelapa');?>" class="btn btn-primary bolder">
			<i class="icon-file-text"></i> Buka Transaksi Air Kelapa
		</a>		
	</h3>
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="page-header">
				<?php echo form_open('monitor/timbang_airkelapa',array('id'=>'formTimbangAirKelapa' ,'class'=>'form-horizontal')); ?>
			...
			<div class="trx-user-info trx-user-info-striped">				
				...
				<div class="trx-info-row">
					...
					<div class="trx-info-value"><?php echo $this->m_trnhasil->get_inspector($headerid, 'AK')['username'];?></div>
				</div>
			</div>
