...
<div class="page-content">	
	<div class="row-fluid">
		<div class="span12">
			<div class="judul">
				<i class="icon-table middle"></i>  Monitor Air Kelapa
			</div>
			
			<div class="page-header">
				<?php echo form_open('monitor/timbang_airkelapa',array('id'=>'formTimbangKelapa' ,'class'=>'form-horizontal')); ?>
					...
					<?php
						...
						foreach ($record as $r){
							...
							echo "<tr>
								...
								<td class='right'>".$r->TotalAK."</td>
								<td class='center'><a href='detail/airkelapa/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-info'><i class='icon-info'></i></a>
								</tr>";
						}
					?>
				</tbody>
