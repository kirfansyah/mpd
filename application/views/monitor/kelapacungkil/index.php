...
<div class="page-content">	
	<div class="row-fluid">
		<div class="span12">
			<div class="judul">
				<i class="icon-table middle"></i>  Monitor Kelapa Cungkil
			</div>
					...
					<?php
						...
						foreach ($record as $r){
							...
							echo "<tr>
								...
								<td class='right'>".$r->TotalKC."</td>
								<td class='center'><a href='detail/kelapacungkil/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-info'><i class='icon-info'></i></a>
								</tr>";
						}
					?>
				</tbody>
