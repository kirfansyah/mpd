...
<div class="page-content">	
	<div class="row-fluid">
		<div class="span12">
			<div class="judul">
				<i class="icon-table middle"></i>  Monitor White Meat
			</div>
					...
					<?php
						...
						foreach ($record as $r){
							...
							echo "<tr>
								...
								<td class='right'>".floatval(number_format($r->TotalTimbangan, 4, ',', '.'))."</td>
								<td class='right'>".floatval($r->TotalPotLain)."</td>
								<td class='right'>".floatval($r->TotalPotAir)."</td>
								<td class='right'>".floatval($r->TotalTimbangan - $r->TotalPotLain - $r->TotalPotAir)."</td>
								<td class='center'><a href='detail/whitemeat/?id=".$r->HasilHeaderID."' class='btn btn-mini btn-info'><i class='icon-info'></i></a>
								</tr>";
						}
					?>
				</tbody>
