	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="page-header">
				...
				<button id="btnUpdateBug" class="btn btn-info btn-small" type="submit">
					<i class="icon-bug"></i> Clear Data Error
				</button>
...
<script type="text/javascript">
	...
	$('#btnUpdateBug').click(function(e){
		e.preventDefault();
		$.blockUI({			
			message	: '<h5><img src="<?php echo base_url();?>assets/images/Preloader_21.gif" /> Sedang proses harap tunggu...</h5>'						
		});
		...
		$.ajax(
			{
				type:'POST',
				url:'<?php echo site_url('laporan/clearbug')?>',
			    data:{'tgl':tgl},
